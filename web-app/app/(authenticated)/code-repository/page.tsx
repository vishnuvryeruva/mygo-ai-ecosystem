        ...
        <div className="doc-hub-page scrollbar-hide">
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm mb-6">
                ...
                <div className="flex justify-end mt-5">
                    <button
                        type="button"
                        className="px-4 py-2 rounded-lg bg-emerald-600 text-white text-sm font-bold flex items-center gap-2 shadow-sm hover:bg-emerald-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                        onClick={handleSync}
                        disabled={isLoading || !selectedSourceId}
                        aria-label="Sync Doc"
                    >
                        <svg className={isLoading ? 'animate-spin' : ''} width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            <path d="M21 2v6h-6" />
                            <path d="M3 12a9 9 0 0 1 15-6.7L21 8" />
                            <path d="M3 22v-6h6" />
                            <path d="M21 12a9 9 0 0 1-15 6.7L3 16" />
                        </svg>
                        <span>{isLoading ? 'Syncing…' : 'Sync Doc'}</span>
                    </button>
                </div>
            </div>
