...
const defaultSources: Source[] = [
    { id: '1', name: 'SharePoint Production', tenant: 'tenant-001', authType: 'OAuth 2.0' },
    { id: '2', name: 'Jira Cloud', tenant: 'tenant-002', authType: 'API Key' },
]
...
export default function SettingsPage() {
    ...
    const handleAddSource = () => {
        if (!connectionForm.sourceName || !connectionForm.tenantId) return
        const newSource: Source = {
            id: Date.now().toString(),
            name: connectionForm.sourceName,
            tenant: connectionForm.tenantId,
            authType: connectionForm.authType || 'OAuth 2.0',
        }
                            ...
                            {sources.map((source) => (
                                <div key={source.id} className="settings-source-card">
                                    ...
                                    <div className="settings-source-info">
                                        ...
                                        <div className="settings-source-meta">Tenant: {source.tenant} · Auth: {source.authType}</div>
                                    </div>
                                    <div className="settings-source-actions">
                                        <button className="settings-icon-btn" title="Edit">
                                ...
                                <div className="settings-modal" onClick={e => e.stopPropagation()}>
                                    ...
                                    <div className="settings-modal-body">
                                        <div className="settings-form-group">
                                            ...
                                            <input
                                                type="text"
                                                placeholder="e.g. SharePoint Production"
                                        ...
                                        <div className="settings-form-group">
                                            ...
                                            <input
                                                ...
                                                onChange={e => setConnectionForm({ ...connectionForm, tenantId: e.target.value })}
                                            />
                                        </div>
                                        <div className="settings-form-group">
                                        ...
                                        <div className="settings-form-group">
                                            <label>Identity Zone</label>
                                            <input
                                                type="text"
                                                placeholder="e.g. us-east"
                                                value={connectionForm.identityZone}
                                                onChange={e => setConnectionForm({ ...connectionForm, identityZone: e.target.value })}
                                            />
                                        </div>
                                        <div className="settings-form-group">
                                            <label>Region</label>
                                    ...
                                    <div className="settings-modal-footer">
                                        <button className="btn btn-primary" onClick={handleAddSource}>Save</button>
